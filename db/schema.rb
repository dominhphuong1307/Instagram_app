...
ActiveRecord::Schema.define(version: 2020_10_12_023853) do
  ...
  create_table "post_hash_tags", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "post_id"
